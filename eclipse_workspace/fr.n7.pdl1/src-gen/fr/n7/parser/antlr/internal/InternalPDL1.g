...
@after {
	...
	(
		...
		{
			$current = $this_RessourceAllouee_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleRessourceAllouee
entryRuleRessourceAllouee returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRessourceAlloueeRule()); }
	iv_ruleRessourceAllouee=ruleRessourceAllouee
	{ $current=$iv_ruleRessourceAllouee.current; }
	EOF;

// Rule RessourceAllouee
ruleRessourceAllouee returns [EObject current=null]
@init {
	enterRule();
}
@after {
