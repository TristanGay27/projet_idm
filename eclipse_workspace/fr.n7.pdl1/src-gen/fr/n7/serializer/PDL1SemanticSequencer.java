...
public class PDL1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PDL1Package.eINSTANCE)
			...
			case PDL1Package.PROCESS:
				...
				return; 
			case PDL1Package.RESSOURCE_ALLOUEE:
				sequence_RessourceAllouee(context, (RessourceAllouee) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     ProcessElement returns RessourceAllouee
	 *     RessourceAllouee returns RessourceAllouee
	 *
	 * Constraint:
	 *     (ressources=[Ressources|ID] number=INT)
	 * </pre>
	 */
	protected void sequence_RessourceAllouee(ISerializationContext context, RessourceAllouee semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCE_ALLOUEE__RESSOURCES) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCE_ALLOUEE__RESSOURCES));
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCE_ALLOUEE__NUMBER) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCE_ALLOUEE__NUMBER));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRessourceAlloueeAccess().getRessourcesRessourcesIDTerminalRuleCall_0_0_1(), semanticObject.eGet(PDL1Package.Literals.RESSOURCE_ALLOUEE__RESSOURCES, false));
		feeder.accept(grammarAccess.getRessourceAlloueeAccess().getNumberINTTerminalRuleCall_2_0(), semanticObject.getNumber());
		feeder.finish();
	}
	...
	protected void sequence_Ressources(ISerializationContext context, Ressources semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCES__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCES__NAME));
			if (transientValues.isValueTransient(semanticObject, PDL1Package.Literals.RESSOURCES__QUANTITY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PDL1Package.Literals.RESSOURCES__QUANTITY));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRessourcesAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getRessourcesAccess().getQuantityINTTerminalRuleCall_3_0(), semanticObject.getQuantity());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID (ressources+=RessourceAllouee ressources+=RessourceAllouee*)?)
	 * </pre>
	 */
