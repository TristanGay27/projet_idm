...
public interface PDL1Package extends EPackage
{
   ...
   * @ordered
   */
  int WORK_DEFINITION__RESSOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 1;
  ...
  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.RessourceAlloueeImpl <em>Ressource Allouee</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.RessourceAlloueeImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessourceAllouee()
   * @generated
   */
  int RESSOURCE_ALLOUEE = 3;
   ...
   * @ordered
   */
  int RESSOURCE_ALLOUEE__RESSOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int RESSOURCE_ALLOUEE__NUMBER = PROCESS_ELEMENT_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Ressource Allouee</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int RESSOURCE_ALLOUEE_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.WorkDefinition#getRessources <em>Ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Ressources</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getRessources()
   * @see #getWorkDefinition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.RessourceAllouee <em>Ressource Allouee</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Ressource Allouee</em>'.
   * @see fr.n7.pDL1.RessourceAllouee
   * @generated
   */
  EClass getRessourceAllouee();

  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.RessourceAllouee#getRessources <em>Ressources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Ressources</em>'.
   * @see fr.n7.pDL1.RessourceAllouee#getRessources()
   * @see #getRessourceAllouee()
   * @generated
   */
  EReference getRessourceAllouee_Ressources();

  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.RessourceAllouee#getNumber <em>Number</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Number</em>'.
   * @see fr.n7.pDL1.RessourceAllouee#getNumber()
   * @see #getRessourceAllouee()
   * @generated
   */
  EAttribute getRessourceAllouee_Number();
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Ressources#getQuantity <em>Quantity</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Quantity</em>'.
   * @see fr.n7.pDL1.Ressources#getQuantity()
   * @see #getRessources()
   * @generated
   */
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.RessourceAlloueeImpl <em>Ressource Allouee</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.RessourceAlloueeImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getRessourceAllouee()
     * @generated
     */
    EClass RESSOURCE_ALLOUEE = eINSTANCE.getRessourceAllouee();
     ...
     * @generated
     */
    EReference RESSOURCE_ALLOUEE__RESSOURCES = eINSTANCE.getRessourceAllouee_Ressources();
     ...
     * @generated
     */
    EAttribute RESSOURCE_ALLOUEE__NUMBER = eINSTANCE.getRessourceAllouee_Number();
