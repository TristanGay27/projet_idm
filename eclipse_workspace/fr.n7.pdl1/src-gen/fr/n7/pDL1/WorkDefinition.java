 ...
 *   <li>{@link fr.n7.pDL1.WorkDefinition#getRessources <em>Ressources</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement
{
   ...
   * The list contents are of type {@link fr.n7.pDL1.RessourceAllouee}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Ressources</em>' containment reference list.
   * @see fr.n7.pDL1.PDL1Package#getWorkDefinition_Ressources()
   * @model containment="true"
   * @generated
   */
  EList<RessourceAllouee> getRessources();
