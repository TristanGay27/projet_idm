...
public class PDL1Switch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        RessourceAllouee ressourceAllouee = (RessourceAllouee)theEObject;
        T result = caseRessourceAllouee(ressourceAllouee);
        if (result == null) result = caseProcessElement(ressourceAllouee);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Ressource Allouee</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Ressource Allouee</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRessourceAllouee(RessourceAllouee object)
  {
    return null;
  }
