...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
   ...
   * @generated
   */
  private EClass ressourceAlloueeEClass = null;
   ...
   */
  @Override
  public EClass getRessourceAllouee()
  {
    return ressourceAlloueeEClass;
  }
   ...
   */
  @Override
  public EReference getRessourceAllouee_Ressources()
  {
    return (EReference)ressourceAlloueeEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getRessourceAllouee_Number()
  {
    return (EAttribute)ressourceAlloueeEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    ressourceAlloueeEClass = createEClass(RESSOURCE_ALLOUEE);
    createEReference(ressourceAlloueeEClass, RESSOURCE_ALLOUEE__RESSOURCES);
    createEAttribute(ressourceAlloueeEClass, RESSOURCE_ALLOUEE__NUMBER);
  ...
  public void initializePackageContents()
  {
    ...
    ressourceAlloueeEClass.getESuperTypes().add(this.getProcessElement());
    ...
    initEReference(getWorkDefinition_Ressources(), this.getRessourceAllouee(), null, "ressources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(ressourceAlloueeEClass, RessourceAllouee.class, "RessourceAllouee", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRessourceAllouee_Ressources(), this.getRessources(), null, "ressources", null, 0, 1, RessourceAllouee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRessourceAllouee_Number(), ecorePackage.getEInt(), "number", null, 0, 1, RessourceAllouee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
