...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRessourceAlloueeAccess().getGroup(), "rule__RessourceAllouee__Group__0");
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getRessourcesAssignment_2_1(), "rule__WorkDefinition__RessourcesAssignment_2_1");
			builder.put(grammarAccess.getWorkDefinitionAccess().getRessourcesAssignment_2_2_1(), "rule__WorkDefinition__RessourcesAssignment_2_2_1");
			builder.put(grammarAccess.getRessourceAlloueeAccess().getRessourcesAssignment_0(), "rule__RessourceAllouee__RessourcesAssignment_0");
			builder.put(grammarAccess.getRessourceAlloueeAccess().getNumberAssignment_2(), "rule__RessourceAllouee__NumberAssignment_2");
			builder.put(grammarAccess.getRessourcesAccess().getNameAssignment_1(), "rule__Ressources__NameAssignment_1");
			builder.put(grammarAccess.getRessourcesAccess().getQuantityAssignment_3(), "rule__Ressources__QuantityAssignment_3");
