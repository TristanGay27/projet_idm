 ...
 *   <li>{@link petri.impl.arcsPonderesImpl#getTypeArc <em>Type Arc</em>}</li>
...
public class arcsPonderesImpl extends petriElementImpl implements arcsPonderes {
	 ...
	 * @ordered
	 */
	protected static final arcType TYPE_ARC_EDEFAULT = arcType.PLACE_TO_TRANSITION;
	 ...
	 * @ordered
	 */
	protected arcType typeArc = TYPE_ARC_EDEFAULT;
	 ...
	 */
	@Override
	public void setTypeArc(arcType newTypeArc) {
		arcType oldTypeArc = typeArc;
		typeArc = newTypeArc == null ? TYPE_ARC_EDEFAULT : newTypeArc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetriPackage.ARCS_PONDERES__TYPE_ARC, oldTypeArc, typeArc));
	}
