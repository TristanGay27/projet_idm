...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass ressourcesAlloueesEClass = null;
	 ...
	 */
	@Override
	public EAttribute getRessources_Quantity() {
	 ...
	 */
	@Override
	public EReference getRessources_Allouees() {
	 ...
	 */
	@Override
	public EAttribute getRessources_Consumable() {
		return (EAttribute)ressourcesEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EClass getRessourcesAllouees() {
		return ressourcesAlloueesEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getRessourcesAllouees_Number() {
		return (EAttribute)ressourcesAlloueesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getRessourcesAllouees_WorkDefinition() {
		return (EReference)ressourcesAlloueesEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getRessourcesAllouees_Ressources() {
		return (EReference)ressourcesAlloueesEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(ressourcesEClass, RESSOURCES__QUANTITY);
		createEReference(ressourcesEClass, RESSOURCES__ALLOUEES);
		createEAttribute(ressourcesEClass, RESSOURCES__CONSUMABLE);

		ressourcesAlloueesEClass = createEClass(RESSOURCES_ALLOUEES);
		createEAttribute(ressourcesAlloueesEClass, RESSOURCES_ALLOUEES__NUMBER);
		createEReference(ressourcesAlloueesEClass, RESSOURCES_ALLOUEES__WORK_DEFINITION);
		createEReference(ressourcesAlloueesEClass, RESSOURCES_ALLOUEES__RESSOURCES);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_Ressources(), this.getRessourcesAllouees(), this.getRessourcesAllouees_WorkDefinition(), "ressources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRessources_Name(), ecorePackage.getEString(), "name", null, 1, 1, Ressources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRessources_Quantity(), ecorePackage.getEInt(), "quantity", null, 0, 1, Ressources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessources_Allouees(), this.getRessourcesAllouees(), this.getRessourcesAllouees_Ressources(), "allouees", null, 0, -1, Ressources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRessources_Consumable(), ecorePackage.getEBoolean(), "consumable", null, 0, 1, Ressources.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(ressourcesAlloueesEClass, RessourcesAllouees.class, "RessourcesAllouees", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRessourcesAllouees_Number(), ecorePackage.getEInt(), "number", null, 1, 1, RessourcesAllouees.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourcesAllouees_WorkDefinition(), this.getWorkDefinition(), this.getWorkDefinition_Ressources(), "WorkDefinition", null, 1, 1, RessourcesAllouees.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourcesAllouees_Ressources(), this.getRessources(), this.getRessources_Allouees(), "ressources", null, 1, 1, RessourcesAllouees.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
