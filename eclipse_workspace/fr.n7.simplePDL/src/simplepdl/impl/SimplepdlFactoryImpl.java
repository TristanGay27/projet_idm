...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.RESSOURCES: return createRessources();
			case SimplepdlPackage.RESSOURCES_ALLOUEES: return createRessourcesAllouees();
			default:
	 ...
	 */
	@Override
	public RessourcesAllouees createRessourcesAllouees() {
		RessourcesAlloueesImpl ressourcesAllouees = new RessourcesAlloueesImpl();
		return ressourcesAllouees;
	}
