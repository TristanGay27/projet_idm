...
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	 ...
	 * @ordered
	 */
	protected EList<RessourcesAllouees> ressources;
	 ...
	 */
	@Override
	public EList<RessourcesAllouees> getRessources() {
		if (ressources == null) {
			ressources = new EObjectContainmentWithInverseEList<RessourcesAllouees>(RessourcesAllouees.class, this, SimplepdlPackage.WORK_DEFINITION__RESSOURCES, SimplepdlPackage.RESSOURCES_ALLOUEES__WORK_DEFINITION);
		}
		return ressources;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCES:
				getRessources().clear();
				getRessources().addAll((Collection<? extends RessourcesAllouees>)newValue);
				return;
		}
