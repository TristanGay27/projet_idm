...
/**
 * This is the item provider adapter for a {@link petri.place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class placeItemProvider extends petriElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_place_nom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_place_nom_feature", "_UI_place_type"),
				 PetriPackage.Literals.PLACE__NOM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetriPackage.Literals.PLACE__JETONS,
				 true,
				 false,
				 false,
	...
	protected void addLinksToArcsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_place_linksToArcs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_place_linksToArcs_feature", "_UI_place_type"),
				 PetriPackage.Literals.PLACE__LINKS_TO_ARCS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((place)object).getNom();
