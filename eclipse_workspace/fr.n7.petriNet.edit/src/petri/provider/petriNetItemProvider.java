...
/**
 * This is the item provider adapter for a {@link petri.petriNet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class petriNetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_petriNet_nom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_petriNet_nom_feature", "_UI_petriNet_type"),
				 PetriPackage.Literals.PETRI_NET__NOM,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetriPackage.Literals.PETRI_NET__PETRIELEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((petriNet)object).getNom();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetriPackage.Literals.PETRI_NET__PETRIELEMENTS,
				 PetriFactory.eINSTANCE.createpetriElement()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PetriPackage.Literals.PETRI_NET__PETRIELEMENTS,
				 PetriFactory.eINSTANCE.createarcsPonderes()));
	}
